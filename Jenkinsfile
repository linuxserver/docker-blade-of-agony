pipeline {
  ...
  environment {
    ...
    EXT_USER = 'Realm667'
    EXT_REPO = 'WolfenDoom'
    BUILD_VERSION_ARG = 'BOA_RELEASE'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-blade-of-agony'
    CONTAINER_NAME = 'blade-of-agony'
    DOCKERHUB_IMAGE = 'linuxserver/blade-of-agony'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/blade-of-agony'
    PR_DOCKERHUB_IMAGE = 'lspipepr/blade-of-agony'
    DIST_IMAGE = 'debian'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-blade-of-agony/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-blade-of-agony\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-blade-of-agony\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Blade-of-agony\" \
          --label \"org.opencontainers.image.description=[Wolfenstein: Blade of Agony](https://boa.realm667.com/) is a story-driven WWII shooter inspired by Wolfenstein and Doom.\" \
